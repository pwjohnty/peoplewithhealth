...
//    public ObservableCollection<activefrequency> Weeklylistitems = new ObservableCollection<activefrequency>();
...
//    public bool ShareTimes = false;
//    public bool ShowhideQuickAdd = true; 
...
//            FreqtitleConfirm.Text = "Frequency " + "(" + NewuserActivity.frequency + ")"; 
...
//            if(ShareTimes == true)
//            {
//                //Weekly Joined - Split item days.count
//                foreach (var item in timeslistitems)
//                {
//                    string settime = item.Timespan.ToString(@"hh\:mm");
...
//                        NewuserActivity.activityfrequencylist.Add(ActivityTime);
//                    }
//                }
//            }
//            else
...
//            //Old 
//            //if (weeklyalladd != null && weeklyalladd.Any())
//            //{
//            //    foreach (var item in weeklyalladd)
//            //    {
//            //        NewuserActivity.activityfrequencylist.Add(item);
//            //    }
//            //}
...
//            QuickAddTimesStack.IsVisible = false;
...
//        {
//            var Selecteditem = e.DataItem as string;
//            ShowhideQuickAdd = Selecteditem != "One";
...
//            //Reset same time across all selected dates if more than one day selected
...
//                    QuickAddTimesStack.IsVisible = ShowhideQuickAdd;
//                    PopulateTimelist();
//                }
//            }
//            else
...
//                    else
//                    {
//                        // Add individual items to timeslistitems (what the user sees)
...
//            {
//                symptomid = Selecteditem.symptomid,
//                symptomtitle = Selecteditem.symptomtitle
//            };
...
//            else
//            {
//                 var existingSymptom = SelectedUserSymptoms.FirstOrDefault(s => s.symptomid == AdduserSymptom.symptomid);

//                if (existingSymptom != null)
//                {
//                    SelectedUserSymptoms.Remove(existingSymptom);
//                }
//                else
//                {
//                    SelectedUserSymptoms.Add(AdduserSymptom); 
